...
-미세 전자기계 시스템 (MEMES) 기술 : 초소형 차원 구조물 또는 이를 포함하는 시스템 구현을 통칭

# MEMES의 기술 분류 

설계 및 소재 
ex) CAD나 시뮬레이션, 고집적 복합적 설계 기술 

가공 
ex)구조용 신소재, 항혈전성 재료 기타 등등

복합화 
ex) 제어 (human interface), 정보처리 분야

에너지 공급 
ex) 에너지 내부 기술, 에너지 외부 기술 
...
1. 자동차 분야 : 압력, 가속도, 자이로, 유체 제어용 밸브, 온도 센성 등의 분야
2. 정보통신 분야 : RF MEMES -> 고주파 관련 소자, 미소 반자경, 미소 렌즈 기타 등등
3. 컴퓨터 사무 자동화 기기 분야 -> 고해상도 프린터 잉크젯 헤드
4. 전자, 가전 및 설비 분야
5. 의료 및 환경 분야  
...
화학 전지: 재사용이 불가한 1차 전지 - 공기 아연 전지 

에너지 저장 시스템: 에너지를 효율적으로 사용할 수 있도록 저장, 관리하는 시스템 

물리 전지: 충전 후 재 사용 가능한 2차 전지 ex) 공기 아연 2차전지, 납 축전지, 리튬 2차 전지, NI-CD 2차 전지, NI-MH  2차 전지 

초고용량 커패시터: 화학 전지아 물리 전지의 중간 범위에 속하는 전지 
